      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute -top-7 right-0 md:-right-4 z-20 w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 text-white transition-all backdrop-blur-md border border-white/10 hover:border-white/30 cursor-pointer"
              aria-label="Close trailer"
            >
              <FiX size={24} />
            </button>

            {/* Modal Body with rounding and clipping */}
            <div className="w-full h-full bg-black rounded-2xl overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.6)] border border-white/5">
